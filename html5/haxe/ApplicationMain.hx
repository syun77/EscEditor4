...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("EscapeGameEditor", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("EscapeGameEditor", null, 380, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "EscapeGameEditor";
		app.meta["name"] = "EscapeGameEditor";
